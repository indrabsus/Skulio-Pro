    ...
    <table class="table table-striped">
        ...
        @foreach ($data as $d)
            <tr>
                <td>{{ $no++ }}</td>
                <td>{{ $d->kode_mesin }}</td>
                <td><a class="btn btn-success btn-sm mb-1" data-toggle="modal" data-target="#edit" wire:click="edit({{ $d->id_mesin }})"><i class="fa fa-edit"></i></a>
                    <a class="btn btn-danger btn-sm mb-1" data-toggle="modal" data-target="#k_hapus" wire:click="k_hapus({{ $d->id_mesin }})"><i class="fa fa-trash"></i></a>
                    </td>
            </tr>
        @endforeach
    </table>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="form-group">
                ...
                <input type="text" wire:model.live="kode_mesin" class="form-control">
